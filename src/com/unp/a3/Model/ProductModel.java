...
public class ProductModel extends Model implements Persistable {
    ...
    public ProductModel(String name, String category, double price, int quantity) {
        this.name = name;
    ...
    public ProductModel(int id, String name, String category, double price, int quantity) {
    ...
    protected Model mapRow(ResultSet rs) throws SQLException {
        ...
        return new ProductModel(id, name, category, price, quantity);
    }
