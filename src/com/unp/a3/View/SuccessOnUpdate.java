 ...
 * @author Usuario
 */
public class SuccessOnUpdate extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(SuccessOnUpdate.class.getName());

    /**
     * Creates new form SucessOnSignup
     */
    public SuccessOnUpdate() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Atualizado com sucesso!");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new SuccessOnUpdate().setVisible(true));
    }
